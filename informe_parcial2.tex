...
Se presentan 5 predicciones aleatorias del set de prueba con el modelo seleccionado, mostrando la clase real, la predicción y la probabilidad estimada $P(\text{Premium})$, demostrando la capacidad operativa del modelo para asistir decisiones de clasificación de vinos.
